        ...
        <>
            ...
            <div className="min-h-screen bg-[#4b4039] text-[#3a2e28] pt-24 p-6 font-sans">
                <div className="max-w-3xl mx-auto space-y-10">
                    {mustChangePassword && (
                        <div className="bg-[#fff3e0] border border-[#e69b00] p-6 rounded-2xl shadow-md">
                            <h2 className="text-xl font-bold mb-4 text-[#5a3e28]">パスワード変更が必要です</h2>
                            <p className="text-sm mb-4">初回ログインのため、新しいパスワードを設定してください。</p>
                            <input
                                type="password"
                                value={newPassword}
                            ...
                            <button
                                ...
                                className="w-full bg-[#5a3e28] text-white py-2 rounded hover:bg-[#7a5639]"
                            >
                                パスワードを変更
                            </button>
                        </div>
